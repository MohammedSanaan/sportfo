    ...
    <section className="relative flex min-h-[520px] w-full flex-col items-center justify-between overflow-hidden bg-stitch-navy px-4 py-16 sm:min-h-[600px] sm:py-20">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-2 text-center">
        <h1 className="text-3xl leading-tight font-bold text-white drop-shadow-md sm:text-4xl md:text-5xl">
          India&apos;s Complete Sports Ecosystem
        </h1>
        ...
        <p className="mx-auto mt-4 max-w-2xl text-base font-medium text-white drop-shadow-md sm:mt-6 sm:text-lg md:text-xl">
          Connecting Athletes, Academies, Coaches, Experts, Creators, Sponsors
          &amp; CSR Teams — All in One Platform
        </p>
      </div>
