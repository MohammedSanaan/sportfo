...
const en = {
  ...
  register: {
    ...
    achievements: {
      ...
      otherTypeSpecify: "Please specify the achievement type",
      otherTypeSpecifyPlaceholder: "Briefly describe this achievement",
      otherTypeSpecifyRequired: "Please describe this achievement.",
